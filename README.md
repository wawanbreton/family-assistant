# family-assistant
An application to help organize your family life by gamifying the kids tasks. Tasks are spawn every day based on a config file, and have to be done at a certain time. By doing so, the kid earns points, with which they can spend to buy decorative elements (background, fonts, icons) or special rewards (specific food, right to do something unusual).
...
![Ĝlobal screenshot](doc/screenshot.png)
